    ...
    <section class="games-section">
        <div class="game-card">
            ...
            <div class="game-options">
                <a href="{{ route('games.dice', ['pick' => 'under']) }}" class="game-option">&lt; 7 <span style="opacity:0.45; margin-left:8px;">( &times; 2 )</span></a>
                <a href="{{ route('games.dice', ['pick' => 'exact']) }}" class="game-option">= 7 <span style="opacity:0.45; margin-left:8px;">( &times; 5 )</span></a>
                <a href="{{ route('games.dice', ['pick' => 'over']) }}" class="game-option">&gt; 7 <span style="opacity:0.45; margin-left:8px;">( &times; 2 )</span></a>
            </div>
        ...
        <div class="game-card">
            ...
            <div class="game-options">
                <a href="{{ route('games.coin', ['pick' => 'heads']) }}" class="game-option">Heads <span style="opacity:0.45; margin-left:8px;">( &times; 2 )</span></a>
                <a href="{{ route('games.coin', ['pick' => 'tails']) }}" class="game-option">Tails <span style="opacity:0.45; margin-left:8px;">( &times; 2 )</span></a>
            </div>
